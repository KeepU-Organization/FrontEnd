...
const ModalLinkComp = ({ id, title,  show = false, onClose}: ModalProps) => {
                ...
                <div className="modal-content">
                    ...
                    <div className="modal-body">
                        <div>
                         ...
                         <div>
                             Ingresa a tu email y confirma tu cuenta en el correo que te enviamos.
                         </div>
                    </div>
